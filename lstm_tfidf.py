...
train_tweets = tv.fit_transform(train_data['tweet'])
test_tweets = tv.fit_transform(test_data['tweet'])
#print(train_tweets.shape)
#train_tweets = pad_sequences(train_tweets, maxlen = 100)
#test_tweets = pad_sequences(test_tweets, maxlen = 100)
...
score, accuracy = model.evaluate(test_tweets, y_test, batch_size = 256)
